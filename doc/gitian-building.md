...
*Setup instructions for a Gitian build of Vertexcoin Core using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the Vertexcoin
...
- [Building Vertexcoin Core](#building-litecoin-core)
...
git clone https://github.com/vertexcoin-project/litecoin
...
To build Vertexcoin Core (for Linux, OS X and Windows) just follow the steps under 'perform
...
Output from `gbuild` will look something like
    ...
    From https://github.com/vertexcoin-project/litecoin
...
cd /some/root/path/
git clone https://github.com/vertexcoin-project/litecoin-detached-sigs.git
...
[vertexcoin-project/gitian.sigs.ltc](https://github.com/vertexcoin-project/gitian.sigs.ltc/) repository, or if that's not possible create a pull
