UNIX BUILD NOTES
====================
Some notes on how to build Vertexcoin Core in Unix.
...
memory available when compiling Vertexcoin Core. On systems with less, gcc can be
...
See the section "Disable-wallet mode" to build Vertexcoin Core without wallet.
...
If you want to build Vertexcoin-Qt, make sure that the required packages for Qt development
...
# Configure Vertexcoin Core to use our own-built instance of BDB
cd $VERTEXCOIN_ROOT
./autogen.sh
...
This example lists the steps necessary to setup and build a command line only, non-wallet distribution of the latest changes on Arch Linux:
    ...
    git clone https://github.com/vertexcoin-project/litecoin.git
    cd litecoin/
    ./autogen.sh
...
As mentioned above, when maintaining portability of the wallet between the standard Vertexcoin Core distributions and independently built
...
with 4.8-built Vertexcoin Core is needed follow the steps under "Berkeley DB" above.
