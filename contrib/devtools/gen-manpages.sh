...
VERTEXCOIND=${VERTEXCOIND:-$SRCDIR/litecoind}
VERTEXCOINCLI=${VERTEXCOINCLI:-$SRCDIR/litecoin-cli}
VERTEXCOINTX=${VERTEXCOINTX:-$SRCDIR/litecoin-tx}
VERTEXCOINQT=${VERTEXCOINQT:-$SRCDIR/qt/litecoin-qt}
