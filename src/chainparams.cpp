...
{
    const char* pszTimestamp = "28/Feb/2024 Some News Article";
    const CScript genesisOutputScript = CScript() << ParseHex("049b14f405fd77b2112cd4cf6850aca4fd52859ba7bf5854d5ad2341f97c5c691126ad663d8e1769f808fc6603b2a45d94aaaab4e3c64fdc2db52549a7378f0a02") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("dnsseed.vertexcoin.net", true);
        //vSeeds.emplace_back("seed-a.vertexcoin.loshan.co.uk", true);
        //vSeeds.emplace_back("dnsseed.thrasher.io", true);
        //vSeeds.emplace_back("dnsseed.vertexcointools.com", true);
        //vSeeds.emplace_back("dnsseed.vertexcoinpool.org", true);
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = {0xcc, 0x88, 0xB2, 0x1E};
        base58Prefixes[EXT_SECRET_KEY] = {0xcc, 0x88, 0xAD, 0xE4};
        ...
        chainTxData = ChainTxData{
            ...
            1709148444, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        consensus.powLimit = uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
        consensus.nPowTargetTimespan = 1.5 * 12 * 60 * 60; // 3.5 days
        consensus.nPowTargetSpacing = 1.0 * 60;
        ...
        genesis = CreateGenesisBlock(1709161343, 563373, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xcc97af681c7d130539b2c56695cd1a4f4393dbbf5ebdfdf7048cb3248c583ce8"));
        assert(genesis.hashMerkleRoot == uint256S("0x60b1116e88c17747b775ec36cd122c259147d2f6908cd1c8e1f18b0308e9a56a"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.emplace_back("dnsseed.vertexcoin.net", true);
        //vSeeds.emplace_back("testnet-seed.vertexcointools.com", true);
        //vSeeds.emplace_back("seed-b.vertexcoin.loshan.co.uk", true);
        ...
        checkpointData = (CCheckpointData) {
            {
                {0, uint256S("cc97af681c7d130539b2c56695cd1a4f4393dbbf5ebdfdf7048cb3248c583ce8")},
            }
        };
...
public:
    CRegTestParams() {
        ...
        checkpointData = (CCheckpointData) {
            {
                {0, uint256S("3eabaf935ca87f8a965b8224733665cfd2e3029df11313649c01730fa748417d")},
            }
        };
