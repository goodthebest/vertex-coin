...
#if defined(NDEBUG)
# error "Vertexcoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Vertexcoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s VERX additional fees, %d delta bytes\n",
