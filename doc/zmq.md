...
The Vertexcoin Core daemon can be configured to act as a trusted "border
...
The ZeroMQ feature in Vertexcoin Core requires ZeroMQ API version 4.x or
...
using. Vertexcoind appends an up-counting sequence number to each
